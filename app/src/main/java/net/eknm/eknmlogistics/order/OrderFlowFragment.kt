...
class OrderFlowFragment : BaseFlowFragment<OrderFlowViewModel, LayoutFlowBinding>(),
    ...
    override val bindingInflater: (LayoutInflater, ViewGroup?, Boolean) -> LayoutFlowBinding = LayoutFlowBinding::inflate
